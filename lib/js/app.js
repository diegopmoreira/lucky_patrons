$(document).ready(function() {
  ...
  $(document).scroll(function() {
    ...
    if (scrollBottom < $(".quem-somos").position().top) {
      ...
      scrollBottom > $(".quem-somos").position().top &&
      scrollBottom < $(".doacoes").position().top
    ) {
      ...
      scrollBottom > $(".doacoes").position().top &&
      scrollBottom < $(".interessado").position().top
    ) {
      $(".indicador .stroke-1").attr("x2", "56");
      $(".indicador .stroke-2").attr("x2", "56");
      ...
      scrollBottom > $(".interessado").position().top &&
      scrollBottom < $(".contato").position().top
    ) {
      $(".indicador .stroke-1").attr("x2", "56");
      $(".indicador .stroke-2").attr("x2", "56");
      $(".indicador .stroke-3").attr("x2", "56");
  ...
  $(".o-que-somos-modal").click(function() {
    $(".menu_modal").slideToggle();
    $("html, body").animate({ scrollTop: $(".quem-somos").offset().top }, 500);
  });
  $(".doacoes-modal").click(function() {
    $(".menu_modal").slideToggle();
    $("html, body").animate({ scrollTop: $(".doacoes").offset().top }, 500);
  });
  $(".interessado-modal").click(function() {
    $(".menu_modal").slideToggle();
    $("html, body").animate({ scrollTop: $(".interessado").offset().top }, 500);
  });
  $(".contato-modal").click(function() {
    $(".menu_modal").slideToggle();
    $("html, body").animate({ scrollTop: $(".contato").offset().top }, 500);
  });
});
